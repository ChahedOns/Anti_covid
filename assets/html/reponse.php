...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top mb-10">
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            ...
            <button class="btn btn-outline-secondary my-2 my-sm-0" type="submit" name="logout"><? echo $_SESSION["email_user"]?></button>
            </form> </div>
        ...
        <div class="jumbotron" style="background-image: url('../img/16.jpg');height: 50vh;background-repeat: no-repeat;
        background-size:cover; background-position:center;">
        
            <h1 class="display-3" style="color:white;">Réponse Médicale</h1>
            ...
            <div class="card-body col-md-6px-lg-5 pt-0">
                ...
                <!-- Form -->
                <form class="text-center" style="color: #757575;" action="../../includes/ajoutrep.php" class="col-md-6" method="POST">
                ...
                <div class="form-group">
                         <br>
                        <label for="exampleTextarea">Votre réponse</label>
                    ...
                    <!-- Sign up button -->
                    <button class="btn  btn-secondary btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit"name="ok">Envoyer</button>
