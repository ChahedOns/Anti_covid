...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-lightsticky-top mb-10">
        <a href="../../index.php">
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body px-lg-5 pt-0">
                ...
                <!-- Form -->
                <form class="text-center" style="color: #757575;" action="../../includes/inscripM.php" class="col-md-6" method="POST">
                    <p class="display-3" style="color: rgb(221, 27, 27);"> Fiche de rensignement </p>
                    <div class="form-row">
                        <div class="col">
                            <!-- First name -->
                            <div class="md-form mt-4">
                                <label for="materialRegisterFormFirstName" style="color: rgb(22, 21, 21);"name="np">Nom et
                                    prénom</label>
                    ...
                    <div class="md-form mt-4">
                        <label for="materialRegisterFormFirstName" style="color: rgb(22, 21, 21);">Votre
                            spécialité</label>
                        <input type="text" id="materialRegisterFormFirstName" class="form-control" name="sp">
                    ...
                    <div>
                        <label for="materialRegisterFormFirstName" style="color: rgb(22, 21, 21);">Votre
                            poste</label>
                        <select class="browser-default custom-select mb-4" id="select" name="poste">
                            <option value="" disabled="" selected="">Choisir votre Poste </option>

                            <option value="1">Chef Service</option>
                            <option value="2">Medecin residant</option>
                            <option value="3">Jeune Medecin </option>
                            <option value="4">Spécialiste </option>
                            <option value="5">Stagiére</option>
                        </select>
                    </div>
                    ...
                    <!-- Password -->
                    <div class="md-form mt-4">
                        <label for="materialRegisterFormPassword" style="color: rgb(22, 21, 21);"
                            name="mdp">Mot de passe </label>
                    ...
                    <!-- Sign up button -->
                    <button class="btn  btn-danger btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit"name="ok">Sign
                        in</button>
